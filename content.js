...
(async function () {
  ...
  const CLEAN_TITLE_RE = /\[.*?\]|\(.*?\)|\|.*$|\b(?:4K|2160p|1080p|720p|480p|360p|x265|x264|HEVC|AVC|H\.264|H\.265|WEB-?HDRip|WEB-?DL|BluRay|Blu-?Ray|HDCAM|CAM|DVDRip|HQ[-\s]?HDTS|HDTS|HDRip|WEBRip|ESubs?|HSubs?|Subs?|Dual\s*Audio|Multi\s*Audio|Hindi\s*ORG|Hindi|Tamil|Telugu|Malayalam|English|Korean|Marathi|Bengali|Punjabi|Kannada|Bhojpuri|Gujarati|DD\s*[\d.]+|DDP\s*[\d.]+|DD5\.1|Atmos|ORG|REPACK|AI|Upscale|PreDVD)\b|[\[\](){}|]/gi;
